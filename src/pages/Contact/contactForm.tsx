...
const ContactForm = () => {
  ...
  return (
    <div
      ...
      className="w-full sm:w-[60%] h-fit bg-grayscale rounded-xl pt-10 pb-15 pl-8 pr-8 shadow-2xl text-white  "
    >
      <div>
        <h2
          style={{ fontFamily: "Morganite Bold, sans-serif" }}
          className="message text-7xl bg-green-300 p-2 rounded-xl text-grayscale-200 text-center rounded-br-[0%] relative shadow-2xl"
        >
      ...
      <div className="w-full flex justify-center">
        ...
        >
          <div className="w-full flex flex-col">
            ...
            <input
              className="p-[0.5em] rounded-xl text-grayscale-950 text-black"
